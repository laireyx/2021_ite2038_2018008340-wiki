...
| pagenum_t | **[insert_into_new_root](/Modules/based B+ tree#function-insert_into_new_root)**(tableid_t table_id, pagenum_t left_page_idx, int64_t key, pagenum_t right_page_idx) |
